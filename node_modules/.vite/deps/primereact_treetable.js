...
import {
  InputText
} from "./chunk-GERBXRUD.js";
import {
  IconBase,
  SpinnerIcon
} from "./chunk-5XGS5EDA.js";
import {
  Ripple
} from "./chunk-ITJGLE4Q.js";
import {
  Portal,
  Tooltip
} from "./chunk-AVJHV6VK.js";
import {
  ComponentBase,
  DomHandler,
  EventBus,
  ...
  useUnmountEffect,
  useUpdateEffect
} from "./chunk-J5TBSYYD.js";
import {
  CSSTransition_default
} from "./chunk-ZYUACYFT.js";
import "./chunk-XXMIG7DO.js";
...
var CSSTransition = React13.forwardRef(function(inProps, ref) {
...
var VirtualScroller = React15.memo(React15.forwardRef(function(inProps, ref) {
  ...
  var _React$useState5 = React15.useState(0), _React$useState6 = _slicedToArray2(_React$useState5, 2), pageState = _React$useState6[0], setPageState = _React$useState6[1];
  ...
  var _React$useState9 = React15.useState(props.numToleratedItems), _React$useState10 = _slicedToArray2(_React$useState9, 2), numToleratedItemsState = _React$useState10[0], setNumToleratedItemsState = _React$useState10[1];
  var _React$useState11 = React15.useState(props.loading || false), _React$useState12 = _slicedToArray2(_React$useState11, 2), loadingState = _React$useState12[0], setLoadingState = _React$useState12[1];
  var _React$useState13 = React15.useState([]), _React$useState14 = _slicedToArray2(_React$useState13, 2), loaderArrState = _React$useState14[0], setLoaderArrState = _React$useState14[1];
  ...
  var createLoader = function createLoader2() {
    ...
    var icon = props.loadingIcon || React15.createElement(SpinnerIcon, _extends14({}, loadingIconProps, {
      spin: true
    }));
    ...
    if (!props.loaderDisabled && props.showLoader && loadingState) {
      ...
      return React15.createElement("div", loaderProps, _content);
    }
    return null;
  };
  ...
  if (props.disabled) {
    ...
    return React15.createElement(React15.Fragment, null, props.children, _content2);
  }
  ...
  return React15.createElement("div", rootProps, content, spacer, loader);
}));
...
var BlankIcon = React17.memo(React17.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  return React17.createElement("svg", _extends16({
    ...
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, pti), React17.createElement("rect", {
    width: "1",
    height: "1",
    fill: "currentColor",
    fillOpacity: "0"
...
var DropdownItem = React17.memo(function(props) {
  var mergeProps = useMergeProps();
  ...
  var iconRenderer = function iconRenderer2() {
    if (selected) {
      ...
      return React17.createElement(CheckIcon, checkIconProps);
    }
    var blankIconProps = mergeProps({
      className: cx("blankIcon")
    }, getPTOptions("blankIcon"));
    return React17.createElement(BlankIcon, blankIconProps);
  };
  return React17.createElement("li", _extends16({
    key: props.label
  }, itemProps), checkmark && iconRenderer(), React17.createElement("span", itemGroupLabelProps, content), React17.createElement(Ripple, null));
});
...
var DropdownPanel = React17.memo(React17.forwardRef(function(props, ref) {
  var mergeProps = useMergeProps();
  var ptm = props.ptm, cx = props.cx, sx = props.sx;
  var context = React17.useContext(PrimeReactContext);
  var filterInputRef = React17.useRef(null);
  ...
  var createFooter = function createFooter2() {
    if (props.panelFooterTemplate) {
      ...
      return React17.createElement("div", footerProps, content);
    }
    return null;
  };
  ...
  var createEmptyMessage = function createEmptyMessage2(emptyMessage, isFilter) {
    ...
    return React17.createElement("li", emptyMessageProps, message);
  };
  var createItem = function createItem2(option, index) {
    ...
    if (option.group && props.optionGroupLabel) {
      ...
      return React17.createElement("li", _extends16({
        key
      }, itemGroupProps), React17.createElement("span", itemGroupLabelProps, groupContent));
    }
    var optionKey = props.getOptionRenderKey(option) + "_" + index;
    var optionLabel = props.getOptionLabel(option);
    var disabled = props.isOptionDisabled(option);
    return React17.createElement(DropdownItem, {
      key: optionKey,
      label: optionLabel,
      index,
  ...
  var createFilterClearIcon = function createFilterClearIcon2() {
    if (props.showFilterClear && props.filterValue) {
      ...
      var icon = props.filterClearIcon || React17.createElement(TimesIcon, clearIconProps);
  ...
  var createFilter = function createFilter2() {
    if (props.filter) {
      ...
      var icon = props.filterIcon || React17.createElement(SearchIcon, filterIconProps);
      ...
      var content = React17.createElement("div", filterContainerProps, React17.createElement("input", filterInputProps), clearIcon, filterIcon);
      ...
      return React17.createElement("div", headerProps, content);
    }
    return null;
  };
  var createContent = function createContent2() {
    if (props.virtualScrollerOptions) {
      var virtualScrollerProps = _objectSpread$1(_objectSpread$1({}, props.virtualScrollerOptions), {
        ...
        contentTemplate: function contentTemplate(options) {
          ...
          return React17.createElement("ul", listProps2, content);
        }
      });
      return React17.createElement(VirtualScroller, _extends16({
    ...
    return React17.createElement("div", wrapperProps, React17.createElement("ul", listProps, items));
  };
  var createElement25 = function createElement26() {
    ...
    return React17.createElement(CSSTransition, _extends16({
      nodeRef: ref
...
var Dropdown = React17.memo(React17.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React17.useContext(PrimeReactContext);
  var props = DropdownBase.getProps(inProps, context);
  var _React$useState = React17.useState(""), _React$useState2 = _slicedToArray3(_React$useState, 2), filterState = _React$useState2[0], setFilterState = _React$useState2[1];
  var _React$useState3 = React17.useState(false), _React$useState4 = _slicedToArray3(_React$useState3, 2), focusedState = _React$useState4[0], setFocusedState = _React$useState4[1];
  var _React$useState5 = React17.useState(-1), _React$useState6 = _slicedToArray3(_React$useState5, 2), focusedOptionIndex = _React$useState6[0], setFocusedOptionIndex = _React$useState6[1];
  var _React$useState7 = React17.useState(false), _React$useState8 = _slicedToArray3(_React$useState7, 2), overlayVisibleState = _React$useState8[0], setOverlayVisibleState = _React$useState8[1];
  var clickedRef = React17.useRef(false);
  var elementRef = React17.useRef(null);
  var overlayRef = React17.useRef(null);
  var firstHiddenFocusableElementOnOverlay = React17.useRef(null);
  var lastHiddenFocusableElementOnOverlay = React17.useRef(null);
  var inputRef = React17.useRef(props.inputRef);
  var focusInputRef = React17.useRef(props.focusInputRef);
  var virtualScrollerRef = React17.useRef(null);
  var searchTimeout = React17.useRef(null);
  var searchValue = React17.useRef(null);
  ...
  var createHiddenSelect = function createHiddenSelect2() {
    ...
    return React17.createElement("div", hiddenSelectedMessageProps, React17.createElement("select", selectProps, React17.createElement("option", optionProps, option.label)));
  };
  var createKeyboardHelper = function createKeyboardHelper2() {
    ...
    return React17.createElement("div", hiddenSelectedMessageProps, React17.createElement("input", inputProps));
  };
  var createLabel = function createLabel2() {
    ...
    if (props.editable) {
      ...
      return React17.createElement("input", _inputProps);
    }
    var content = props.valueTemplate ? ObjectUtils.getJSXElement(props.valueTemplate, selectedOption, props) : label || props.placeholder || props.emptyMessage || React17.createElement(React17.Fragment, null, " ");
    ...
    return React17.createElement("span", inputProps, content);
  };
  ...
  var createClearIcon = function createClearIcon2() {
    if (props.value != null && props.showClear && !props.disabled && !ObjectUtils.isEmpty(props.options)) {
      ...
      var icon = props.clearIcon || React17.createElement(TimesIcon, clearIconProps);
  ...
  var createLoadingIcon = function createLoadingIcon2() {
    ...
    var icon = props.loadingIcon || React17.createElement(SpinnerIcon, {
      spin: true
    });
    ...
    return React17.createElement("div", loadingButtonProps, loadingIcon);
  };
  var createDropdownIcon = function createDropdownIcon2() {
    ...
    var icon = !overlayVisibleState ? props.dropdownIcon || React17.createElement(ChevronDownIcon, dropdownIconProps) : props.collapseIcon || React17.createElement(ChevronUpIcon, dropdownIconProps);
    ...
    return React17.createElement("div", triggerProps, dropdownIcon2);
  };
  ...
  return React17.createElement(React17.Fragment, null, React17.createElement("div", rootProps, keyboardHelper, hiddenSelect, labelElement, clearIcon, dropdownIcon, React17.createElement(DropdownPanel, _extends16({
    hostName: "Dropdown",
    ref: overlayRef,
    visibleOptions,
    virtualScrollerRef
    ...
    firstFocusableElement: React17.createElement("span", firstHiddenFocusableElementProps),
    lastFocusableElement: React17.createElement("span", lastHiddenFocusableElementProps),
    sx
  }))), hasTooltip && React17.createElement(Tooltip, _extends16({
    target: elementRef,
    content: props.tooltip,
    pt: ptm("tooltip")
  }, props.tooltipOptions)));
...
var CurrentPageReport = React18.memo(function(inProps) {
  var mergeProps = useMergeProps();
  ...
  var element = React18.createElement("span", currentProps, text);
  if (props.template) {
...
var FirstPageLink = React18.memo(function(inProps) {
  var mergeProps = useMergeProps();
  var context = React18.useContext(PrimeReactContext);
  ...
  var icon = props.firstPageLinkIcon || React18.createElement(AngleDoubleLeftIcon, firstPageIconProps);
  ...
  var element = React18.createElement("button", firstPageButtonProps, firstPageLinkIcon, React18.createElement(Ripple, null));
  if (props.template) {
    var defaultOptions = {
      onClick: props.onClick,
      className,
...
var JumpToPageInput = React18.memo(function(inProps) {
  useMergeProps();
  var context = React18.useContext(PrimeReactContext);
  ...
  var element = React18.createElement(InputNumber, {
    value,
    onChange,
...
var LastPageLink = React18.memo(function(inProps) {
  var mergeProps = useMergeProps();
  var context = React18.useContext(PrimeReactContext);
  ...
  var icon = props.lastPageLinkIcon || React18.createElement(AngleDoubleRightIcon, lastPageIconProps);
  ...
  var element = React18.createElement("button", lastPageButtonProps, lastPageLinkIcon, React18.createElement(Ripple, null));
  if (props.template) {
    var defaultOptions = {
      onClick: props.onClick,
      className,
...
var NextPageLink = React18.memo(function(inProps) {
  var mergeProps = useMergeProps();
  var context = React18.useContext(PrimeReactContext);
  ...
  var icon = props.nextPageLinkIcon || React18.createElement(AngleRightIcon, nextPageIconProps);
  ...
  var element = React18.createElement("button", nextPageButtonProps, nextPageLinkIcon, React18.createElement(Ripple, null));
  if (props.template) {
    var defaultOptions = {
      onClick: props.onClick,
      className,
...
var PageLinks = React18.memo(function(inProps) {
  var mergeProps = useMergeProps();
  var context = React18.useContext(PrimeReactContext);
  ...
  if (props.value) {
    ...
    elements = props.value.map(function(pageLink) {
      ...
      var element = React18.createElement("button", pageButtonProps, pageLink, React18.createElement(Ripple, null));
      if (props.template) {
        var defaultOptions = {
          onClick: function onClick(e) {
            return onPageLinkClick(e, pageLink);
  ...
  return React18.createElement("span", pagesProps, elements);
});
...
var PrevPageLink = React18.memo(function(inProps) {
  var mergeProps = useMergeProps();
  var context = React18.useContext(PrimeReactContext);
  ...
  var icon = props.prevPageLinkIcon || React18.createElement(AngleLeftIcon, prevPageIconProps);
  ...
  var element = React18.createElement("button", prevPageButtonProps, prevPageLinkIcon, React18.createElement(Ripple, null));
  if (props.template) {
    var defaultOptions = {
      onClick: props.onClick,
      className,
...
var RowsPerPageDropdown = React18.memo(function(inProps) {
  useMergeProps();
  var context = React18.useContext(PrimeReactContext);
  ...
  var element = hasOptions ? React18.createElement(React18.Fragment, null, React18.createElement(Dropdown, {
    value: props.value,
    options,
...
var Paginator = React18.memo(React18.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React18.useContext(PrimeReactContext);
  ...
  var createElement25 = function createElement26(key, template) {
    ...
    switch (key) {
      case "FirstPageLink":
        element = React18.createElement(FirstPageLink, {
          hostName: "Paginator",
          key,
          page,
          totalPages,
        ...
        break;
      case "PrevPageLink":
        element = React18.createElement(PrevPageLink, {
          hostName: "Paginator",
          key,
          page,
          totalPages,
        ...
        break;
      case "NextPageLink":
        element = React18.createElement(NextPageLink, {
          hostName: "Paginator",
          key,
          page,
          totalPages,
        ...
        break;
      case "LastPageLink":
        element = React18.createElement(LastPageLink, {
          hostName: "Paginator",
          key,
          page,
          totalPages,
        ...
        break;
      case "PageLinks":
        element = React18.createElement(PageLinks, {
          hostName: "Paginator",
          key,
          page,
          totalPages,
      ...
      case "RowsPerPageDropdown":
        element = React18.createElement(RowsPerPageDropdown, {
          hostName: "Paginator",
          key,
          value: props.rows,
          page,
      ...
      case "CurrentPageReport":
        element = React18.createElement(CurrentPageReport, {
          hostName: "Paginator",
      ...
      case "JumpToPageInput":
        element = React18.createElement(JumpToPageInput, {
          hostName: "Paginator",
          key,
          rows: props.rows,
          page,
  ...
  var leftElement = leftContent && React18.createElement("div", leftProps, leftContent);
  var endProps = mergeProps({
    className: cx("end")
  }, ptm("end"));
  var rightElement = rightContent && React18.createElement("div", endProps, rightContent);
  var rootProps = mergeProps({
    ref: elementRef,
    className: classNames(props.className, cx("root")),
    style: props.style
  }, PaginatorBase.getOtherProps(props), ptm("root"));
  return React18.createElement("div", rootProps, leftElement, elements, rightElement);
}));
...
var MinusIcon = React20.memo(React20.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
function _toConsumableArray2(r) {
  return _arrayWithoutHoles2(r) || _iterableToArray2(r) || _unsupportedIterableToArray$4(r) || _nonIterableSpread2();
}
...
function _slicedToArray5(r, e) {
  return _arrayWithHoles5(r) || _iterableToArrayLimit5(r, e) || _unsupportedIterableToArray$4(r, e) || _nonIterableRest5();
}
...
var TreeTableBodyCell = function TreeTableBodyCell2(props) {
  var _React$useState = React24.useState(false), _React$useState2 = _slicedToArray5(_React$useState, 2), editingState = _React$useState2[0], setEditingState = _React$useState2[1];
  ...
  var closeCell = function closeCell2() {
    setTimeout(function() {
  ...
  var switchCellToViewMode = function switchCellToViewMode2(event) {
  ...
  var editorKeyHelper = columnEditor && React24.createElement("a", editorKeyHelperProps, React24.createElement("span", editorKeyHelperLabelProps));
  ...
  return React24.createElement("td", _extends22({
    ref: elementRef
...
var Checkbox = React24.memo(React24.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React24.useState(false), _React$useState2 = _slicedToArray5(_React$useState, 2), focusedState = _React$useState2[0], setFocusedState = _React$useState2[1];
  ...
  var createInputElement = function createInputElement2() {
    var ariaProps = ObjectUtils.reduceKeys(otherProps, DomHandler.ARIA_PROPS);
    var inputProps = mergeProps(_objectSpread$52({
      id: props.inputId,
      type: "checkbox",
      className: cx("input"),
      name: props.name,
    ...
    return React24.createElement("input", _extends22({
      ref: inputRef
    }, inputProps));
  };
  var createBoxElement = function createBoxElement2() {
    ...
    var checkboxIcon = IconUtils.getJSXIcon(icon, _objectSpread$52({}, iconProps), {
      props,
      checked
    });
    return React24.createElement("div", boxProps, checkboxIcon);
  };
  return React24.createElement(React24.Fragment, null, React24.createElement("div", _extends22({
    ref: elementRef
  }, rootProps), createInputElement(), createBoxElement()), hasTooltip && React24.createElement(Tooltip, _extends22({
    target: elementRef,
    content: props.tooltip,
    pt: ptm("tooltip")
  }, props.tooltipOptions)));
...
var TreeTableRow = React24.memo(function(props) {
  var elementRef = React24.useRef(null);
  React24.useRef(null);
  React24.useRef(null);
  var nodeTouched = React24.useRef(false);
  var mergeProps = useMergeProps();
  var expanded = props.expandedKeys ? props.expandedKeys[props.node.key] !== void 0 : false;
  ...
  var getColumnCheckboxPTOptions = function getColumnCheckboxPTOptions2(column, key) {
    var cProps = getColumnProps(column);
    var columnMetadata = {
      props: cProps,
      parent: props.metaData,
  ...
  var getRowPTOptions = function getRowPTOptions2(key) {
    var rowMetadata = {
      hostName: props.hostName,
      context: {
        index: props.index,
  ...
  var expand = function expand2(event) {
    ...
    var expandedKeys = props.expandedKeys ? _objectSpread$42({}, props.expandedKeys) : {};
  ...
  var collapse = function collapse2(event) {
    var expandedKeys = _objectSpread$42({}, props.expandedKeys);
  ...
  var invokeToggleEvents = function invokeToggleEvents2(event, expanded2) {
    if (expanded2) {
      if (props.onExpand) {
        props.onExpand({
          originalEvent: event,
  ...
  var onCheckboxChange = function onCheckboxChange2(event) {
    var checked = isChecked();
    var selectionKeys = props.selectionKeys ? _objectSpread$42({}, props.selectionKeys) : {};
    if (checked) {
  ...
  var _onKeyDown = function onKeyDown(event, item2) {
    switch (event.code) {
      case "ArrowDown":
        onArrowDownKey(event);
        break;
  ...
  var onTabKey = function onTabKey2() {
    var rows = _toConsumableArray2(DomHandler.find(elementRef.current.parentElement, "tr"));
    var hasSelectedRow = rows.some(function(row2) {
  ...
  var focusRowChange = function focusRowChange2(firstFocusableRow, currentFocusedRow) {
  ...
  var setTabIndexForSelectionMode = function setTabIndexForSelectionMode2(event, nodeTouched2) {
    if (props.selectionMode !== null) {
      var elements = _toConsumableArray2(DomHandler.find(elementRef.current.parentElement, "tr"));
  ...
  var isSelected = function isSelected2() {
    if (props.selectionMode === "single" || props.selectionMode === "multiple" && props.selectionKeys) {
      return props.selectionMode === "single" ? props.selectionKeys === props.node.key : props.selectionKeys[props.node.key] !== void 0;
    }
    return false;
  };
  var isChecked = function isChecked2() {
  ...
  var createToggler = function createToggler2(column) {
    ...
    var icon = expanded ? React24.createElement(ChevronDownIcon, rowTogglerIconProps) : React24.createElement(ChevronRightIcon, rowTogglerIconProps);
    var togglerIcon = IconUtils.getJSXIcon(props.togglerIcon || icon, _objectSpread$42({}, rowTogglerIconProps), {
      props
    });
    ...
    var content = React24.createElement("button", rowTogglerProps, togglerIcon, React24.createElement(Ripple, null));
  ...
  var createCheckbox = function createCheckbox2(column) {
    if (props.selectionMode === "checkbox" && props.node.selectable !== false) {
      var checked = isChecked();
      var partialChecked = isPartialChecked();
      var icon = checked ? props.checkboxIcon || React24.createElement(CheckIcon, null) : partialChecked ? props.checkboxIcon || React24.createElement(MinusIcon, null) : null;
      ...
      return React24.createElement(Checkbox, rowCheckboxProps);
    }
    return null;
  };
  var createCell = function createCell2(column, index) {
    var toggler;
    var checkbox;
    ...
    return React24.createElement(TreeTableBodyCell, _extends22({
      hostName: props.hostName,
  ...
  var createChildren = function createChildren2() {
    if (expanded && props.node.children) {
      return props.node.children.map(function(childNode, index) {
        return React24.createElement(TreeTableRow, {
          hostName: props.hostName,
  ...
  var rowProps = mergeProps({
    ...
    className: classNames(rowClassName, props.node.className)
    // #5983 must be last so all unstyled merging takes place first
  });
  return React24.createElement(React24.Fragment, null, React24.createElement("tr", _extends22({
    ref: elementRef
...
var TreeTableBody = React24.memo(function(props) {
  var mergeProps = useMergeProps();
  ...
  var getPTOptions = function getPTOptions2(key, options) {
    return ptm(key, _objectSpread$32({
      hostName: props.hostName
    }, options));
  };
  ...
  var isExpandedKey = function isExpandedKey2(key) {
    return props.expandedKeys && !!props.expandedKeys[key];
  };
  var onRowClick = function onRowClick2(event, node) {
    if (props.onRowClick) {
      props.onRowClick({
        originalEvent: event,
        node
    ...
    if ((isSingleSelectionMode || isMultipleSelectionMode) && node.selectable !== false) {
      ...
      if (isMultipleSelectionMode && event.shiftKey) {
        ...
        selectionKeys = _objectSpread$32({}, props.selectionKeys);
        ...
        if (metaSelection) {
          ...
          if (selected && metaKey) {
            ...
            if (isSingleSelectionMode) {
              ...
              selectionKeys = !metaKey ? {} : props.selectionKeys ? _objectSpread$32({}, props.selectionKeys) : {};
          ...
          selectionKeys = props.selectionKeys ? _objectSpread$32({}, props.selectionKeys) : {};
          selectionKeys[node.key] = true;
          if (props.onSelect) {
            props.onSelect({
              originalEvent: event,
  ...
  var isSelected = function isSelected2(node) {
    if ((isSingleSelectionMode || isMultipleSelectionMode) && props.selectionKeys) {
      return isSingleSelectionMode ? props.selectionKeys === node.key : props.selectionKeys[node.key] !== void 0;
    }
    return false;
  };
  var createRow = function createRow2(node, index) {
    return React24.createElement(TreeTableRow, {
      hostName: props.hostName,
  ...
  var createRows = function createRows2() {
  ...
  var createEmptyMessage = function createEmptyMessage2() {
    ...
    return React24.createElement("tr", emptyMessageProps, React24.createElement("td", emptyMessageCellProps, content2));
  };
  ...
  return React24.createElement("tbody", tbodyProps, content);
});
...
var RowBase = ComponentBase.extend({
  ...
  getCProp: function getCProp3(row2, name) {
    return ObjectUtils.getComponentProp(row2, name, RowBase.defaultProps);
  }
});
var TreeTableFooter = React24.memo(function(props) {
  var mergeProps = useMergeProps();
  var _props$ptCallbacks = props.ptCallbacks, ptm = _props$ptCallbacks.ptm, ptmo = _props$ptCallbacks.ptmo, cx = _props$ptCallbacks.cx;
  var context = React24.useContext(PrimeReactContext);
  var getColumnProp = function getColumnProp2(column, name) {
  ...
  var createFooterCell = function createFooterCell2(column, index) {
    ...
    var content2 = ObjectUtils.getJSXElement(getColumnProp(column, "footer"), {
      props: getColumnProps(column)
    });
    return React24.createElement("td", footerCellProps, content2);
  };
  var createFooterRow = function createFooterRow2(row2, index) {
    var rowColumns = React24.Children.toArray(RowBase.getCProp(row2, "children"));
    var rowFooterCells = rowColumns.map(createFooterCell);
    var footerRowProps = mergeProps(ptm("footerRow", {
      hostName: props.hostName,
      role: "row"
    }), RowBase.getProps(row2.props, context));
    return React24.createElement("tr", _extends22({}, footerRowProps, {
      key: index
    }), rowFooterCells);
  };
  var createColumnGroup = function createColumnGroup2() {
    var rows = React24.Children.toArray(ColumnGroupBase.getCProp(props.columnGroup, "children"));
    return rows.map(createFooterRow);
  };
  var createColumns = function createColumns2(columns) {
    if (columns) {
      var headerCells = columns.map(createFooterCell);
      var footerRowProps = mergeProps(ptm("footerRow", {
        hostName: props.hostName
      }));
      return React24.createElement("tr", footerRowProps, headerCells);
    }
    return null;
  };
...
var TreeTableHeader = React24.memo(function(props) {
  var mergeProps = useMergeProps();
  var _props$ptCallbacks = props.ptCallbacks, ptm = _props$ptCallbacks.ptm, ptmo = _props$ptCallbacks.ptmo, cx = _props$ptCallbacks.cx;
  var filterTimeout = React24.useRef(null);
  var context = React24.useContext(PrimeReactContext);
  var getColumnProp = function getColumnProp2(column) {
    return column ? typeof (arguments.length <= 1 ? void 0 : arguments[1]) === "string" ? ColumnBase.getCProp(column, arguments.length <= 1 ? void 0 : arguments[1]) : ColumnBase.getCProp((arguments.length <= 1 ? void 0 : arguments[1]) || column, arguments.length <= 2 ? void 0 : arguments[2]) : null;
  };
  var getColumnProps = function getColumnProps2(column) {
    return ColumnBase.getCProps(column);
  };
  var getColumnPTOptions = function getColumnPTOptions2(column, key, params) {
    var cProps = getColumnProps(column);
    var columnMetadata = _objectSpread$23({
      props: cProps,
      parent: props.metaData,
      hostName: props.hostName
    }, params);
  ...
  var onHeaderClick = function onHeaderClick2(event, column) {
  ...
  var onHeaderMouseDown = function onHeaderMouseDown2(event, column) {
  ...
  var onHeaderKeyDown = function onHeaderKeyDown2(event, column) {
    if (event.key === "Enter" || event.code === "Space") {
      onHeaderClick(event, column);
      event.preventDefault();
    }
  };
  var getMultiSortMetaDataIndex = function getMultiSortMetaDataIndex2(column) {
  ...
  var onResizerMouseDown = function onResizerMouseDown2(event, column) {
  ...
  var onFilterInput = function onFilterInput2(e, column) {
  ...
  var hasColumnFilter = function hasColumnFilter2(columns) {
    if (columns) {
  ...
  var getAriaSort = function getAriaSort2(column, sorted, sortOrder) {
    if (getColumnProp(column, "sortable")) {
  ...
  var createSortIcon = function createSortIcon2(column, sorted, sortOrder) {
    if (getColumnProp(column, "sortable")) {
  ...
  var createResizer = function createResizer2(column) {
  ...
  var createSortBadge = function createSortBadge2(column, sortMetaDataIndex) {
    if (sortMetaDataIndex !== -1 && props.multiSortMeta && props.multiSortMeta.length > 1) {
      ...
      return React24.createElement("span", sortBadgeProps, sortMetaDataIndex + 1);
    }
    return null;
  };
  var createTitle = function createTitle2(column, options) {
  ...
  var createHeaderCell = function createHeaderCell2(column, options) {
    var filterElement;
    if (getColumnProp(column, "hidden")) {
      return null;
    }
    if (getColumnProp(column, "filter") && options.renderFilter) {
      filterElement = getColumnProp(column, "filterElement") || React24.createElement(InputText, {
    ...
    if (options.filterOnly) {
      ...
      return React24.createElement("th", _headerCellProps, filterElement);
    }
    var headerCellRef = React24.createRef(null);
    ...
    var headerCellProps = mergeProps(_defineProperty6(_defineProperty6(_defineProperty6(_defineProperty6(_defineProperty6(_defineProperty6(_defineProperty6(_defineProperty6(_defineProperty6({
      role: "columnheader",
    ...
    var header = React24.createElement("div", headerContentProps, title, sortIconElement, sortBadge, filterElement);
    return React24.createElement(React24.Fragment, {
      key: column.columnKey || column.field || options.index
    }, React24.createElement("th", _extends22({
      ref: headerCellRef
    }, headerCellProps), resizer, header), hasTooltip && React24.createElement(Tooltip, _extends22({
  ...
  var createHeaderRow = function createHeaderRow2(row2, index) {
    var rowColumns = React24.Children.toArray(RowBase.getCProp(row2, "children"));
    ...
    return React24.createElement("tr", _extends22({
      role: "row"
    }, headerRowProps, {
      key: index
    }), rowHeaderCells);
  ...
  var createColumns = function createColumns2(columns) {
    if (columns) {
      ...
      if (hasColumnFilter(columns)) {
        return React24.createElement(React24.Fragment, null, React24.createElement("tr", headerRowProps, columns.map(function(col, i) {
          return createHeaderCell(col, {
            index: i,
            filterOnly: false,
            renderFilter: false
          });
        })), React24.createElement("tr", headerRowProps, columns.map(function(col, i) {
          return createHeaderCell(col, {
            index: i,
            filterOnly: true,
            renderFilter: true
...
var TreeTableScrollableView = React24.memo(function(props) {
  var elementRef = React24.useRef(null);
  var scrollHeaderRef = React24.useRef(null);
  var scrollHeaderBoxRef = React24.useRef(null);
  var scrollBodyRef = React24.useRef(null);
  var scrollTableRef = React24.useRef(null);
  var scrollFooterRef = React24.useRef(null);
  var scrollFooterBoxRef = React24.useRef(null);
  var mergeProps = useMergeProps();
  var _props$ptCallbacks = props.ptCallbacks, ptm = _props$ptCallbacks.ptm, cx = _props$ptCallbacks.cx, sx = _props$ptCallbacks.sx;
  var getPTOptions = function getPTOptions2(key, options) {
    return ptm(key, _objectSpread$13({
      hostName: props.hostName
    }, options));
  };
  var setScrollHeight = function setScrollHeight2() {
    if (props.scrollHeight) {
      if (props.scrollHeight.indexOf("%") !== -1) {
        ...
        scrollBodyRef.current.style.height = "100px";
        ...
        var staticHeight = containerHeight - 100;
  ...
  var findDataTableContainer = function findDataTableContainer2(element) {
    if (element) {
      var el = element;
  ...
  var onBodyScroll = function onBodyScroll2() {
  ...
  var createColGroup = function createColGroup2() {
    if (ObjectUtils.isNotEmpty(props.columns)) {
      ...
      return React24.createElement("colgroup", scrollableColgroupProps, cols);
    }
    return null;
  };
  ...
  return React24.createElement("div", _extends22({
    ref: elementRef
  }, scrollableProps), React24.createElement("div", _extends22({
    ref: scrollHeaderRef
  }, scrollableHeaderProps), React24.createElement("div", _extends22({
    ref: scrollHeaderBoxRef
  }, scrollableHeaderBoxProps), React24.createElement("table", scrollableHeaderTableProps, colGroup, props.header))), React24.createElement("div", _extends22({
    ref: scrollBodyRef
  }, scrollableBodyProps), React24.createElement("table", _extends22({
    ref: scrollTableRef
  }, scrollableBodyTableProps), colGroup, props.body)), React24.createElement("div", _extends22({
    ref: scrollFooterRef
  }, scrollableFooterProps), React24.createElement("div", _extends22({
    ref: scrollFooterBoxRef
  }, scrollableFooterBoxProps), React24.createElement("table", scrollableFooterTableProps, colGroup, props.footer))));
});
...
var TreeTable = React24.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React24.useContext(PrimeReactContext);
  var props = TreeTableBase.getProps(inProps, context);
  var _React$useState = React24.useState(props.expandedKeys), _React$useState2 = _slicedToArray5(_React$useState, 2), expandedKeysState = _React$useState2[0], setExpandedKeysState = _React$useState2[1];
  var _React$useState3 = React24.useState(props.first), _React$useState4 = _slicedToArray5(_React$useState3, 2), firstState = _React$useState4[0], setFirstState = _React$useState4[1];
  var _React$useState5 = React24.useState(props.rows), _React$useState6 = _slicedToArray5(_React$useState5, 2), rowsState = _React$useState6[0], setRowsState = _React$useState6[1];
  var _React$useState7 = React24.useState(props.sortField), _React$useState8 = _slicedToArray5(_React$useState7, 2), sortFieldState = _React$useState8[0], setSortFieldState = _React$useState8[1];
  var _React$useState9 = React24.useState(props.sortOrder), _React$useState10 = _slicedToArray5(_React$useState9, 2), sortOrderState = _React$useState10[0], setSortOrderState = _React$useState10[1];
  var _React$useState11 = React24.useState(props.multiSortMeta), _React$useState12 = _slicedToArray5(_React$useState11, 2), multiSortMetaState = _React$useState12[0], setMultiSortMetaState = _React$useState12[1];
  var _React$useState13 = React24.useState(props.filters), _React$useState14 = _slicedToArray5(_React$useState13, 2), filtersState = _React$useState14[0], setFiltersState = _React$useState14[1];
  var _React$useState15 = React24.useState([]), _React$useState16 = _slicedToArray5(_React$useState15, 2), columnOrderState = _React$useState16[0], setColumnOrderState = _React$useState16[1];
  var metaData = {
    props,
    state: {
  ...
  var resizerHelperRef = React24.useRef(null);
  var reorderIndicatorUpRef = React24.useRef(null);
  var reorderIndicatorDownRef = React24.useRef(null);
  var columnResizing = React24.useRef(null);
  var resizeColumn = React24.useRef(null);
  var resizeColumnProps = React24.useRef(null);
  var lastResizerHelperX = React24.useRef(0);
  var iconWidth = React24.useRef(0);
  var iconHeight = React24.useRef(0);
  var draggedColumnEl = React24.useRef(null);
  var draggedColumn = React24.useRef(null);
  var dropPosition = React24.useRef(null);
  var columnSortable = React24.useRef(null);
  var columnSortFunction = React24.useRef(null);
  var columnField = React24.useRef(null);
  var childFocusEvent = React24.useRef(null);
  var _useEventListener = useEventListener({
    type: "mousemove",
    listener: function listener(event) {
  ...
  var saveState = function saveState2() {
    ...
    state2.expandedKeysState = expandedKeysState;
    if (props.selectionKeys && props.onSelectionChange) {
      state2.selectionKeys = props.selectionKeys;
    }
  ...
  var onSort = function onSort2(event) {
  ...
  var sortSingle = function sortSingle2(data2) {
    return _sortNodes(data2);
  };
  var _sortNodes = function sortNodes(data2) {
  ...
  var sortMultiple = function sortMultiple2(data2) {
    var multiSortMeta = getMultiSortMeta();
    if (multiSortMeta) {
      return _sortMultipleNodes(data2, multiSortMeta);
    }
    return data2;
  };
  var _sortMultipleNodes = function sortMultipleNodes(data2, multiSortMeta) {
    var value = _toConsumableArray2(data2);
    var comparator = ObjectUtils.localeComparator(context && context.locale || PrimeReact.locale);
    value.sort(function(node1, node2) {
  ...
  var filter = function filter2(value, field, mode) {
    onFilter({
      value,
      field,
      matchMode: mode
  ...
  var onFilter = function onFilter2(event) {
    ...
    var newFilters = filters ? _objectSpread6({}, filters) : {};
  ...
  var cloneFilters = function cloneFilters2(filters) {
    ...
    if (filters) {
      Object.entries(filters).forEach(function(_ref) {
        var _ref2 = _slicedToArray5(_ref, 2), prop = _ref2[0], value = _ref2[1];
        cloned[prop] = value;
      });
    } else {
      var columns = getColumns();
      cloned = columns.reduce(function(filters2, col) {
  ...
  var onColumnResizeStart = function onColumnResizeStart2(event) {
  ...
  var onColumnResize = function onColumnResize2(event) {
    ...
    resizerHelperRef.current.style.top = "0px";
  ...
  var onColumnResizeEnd = function onColumnResizeEnd2(event) {
  ...
  var findParentScrollableView = function findParentScrollableView2(column) {
    if (column) {
  ...
  var resizeColGroup = function resizeColGroup2(table3, resizeColumnIndex, newColumnWidth, nextColumnWidth) {
    if (table3) {
      var colGroup = table3.children[0].nodeName === "COLGROUP" ? table3.children[0] : null;
      if (colGroup) {
  ...
  var onColumnDragStart = function onColumnDragStart2(e) {
  ...
  var onColumnDragOver = function onColumnDragOver2(e) {
    var event = e.originalEvent, column = e.column;
  ...
  var onColumnDragLeave = function onColumnDragLeave2(e) {
  ...
  var onColumnDrop = function onColumnDrop2(e) {
    var event = e.originalEvent, column = e.column;
    event.preventDefault();
    if (draggedColumnEl.current) {
      ...
      if (allowDrop) {
        var columns = columnOrderState ? getColumns() : React24.Children.toArray(props.children);
        ...
        var columnOrder = [];
        var _iterator2 = _createForOfIteratorHelper2(columns), _step2;
        try {
  ...
  var getExpandedKeys = function getExpandedKeys2() {
  ...
  var findColumnByKey = function findColumnByKey2(columns, key) {
  ...
  var getColumns = function getColumns2() {
    var columns = React24.Children.toArray(props.children);
    if (columns && columns.length) {
      if (props.reorderableColumns && columnOrderState) {
        var orderedColumns = [];
        var _iterator3 = _createForOfIteratorHelper2(columnOrderState), _step3;
        try {
        ...
        return [].concat(orderedColumns, _toConsumableArray2(columns.filter(function(item2) {
  ...
  var isRowSelectionMode = function isRowSelectionMode2() {
    return isSingleSelectionMode() || isMultipleSelectionMode();
  };
  var getFrozenColumns = function getFrozenColumns2(columns) {
    var frozenColumns = null;
    var _iterator4 = _createForOfIteratorHelper2(columns), _step4;
    try {
  ...
  var getScrollableColumns = function getScrollableColumns2(columns) {
    var scrollableColumns = null;
    var _iterator5 = _createForOfIteratorHelper2(columns), _step5;
    try {
  ...
  var filterLocal = function filterLocal2(value) {
    var filteredNodes = [];
    var filters = getFilters();
    var columns = React24.Children.toArray(props.children);
    var isStrictMode = props.filterMode === "strict";
    var _iterator6 = _createForOfIteratorHelper2(value), _step6;
    try {
      for (_iterator6.s(); !(_step6 = _iterator6.n()).done; ) {
        var node = _step6.value;
        var copyNode = _objectSpread6({}, node);
        var localMatch = true;
        ...
        for (var j = 0; j < columns.length; j++) {
          ...
          if (props.globalFilter && !globalMatch) {
            var copyNodeForGlobal = _objectSpread6({}, copyNode);
  ...
  var findFilteredNodes = function findFilteredNodes2(node, paramsWithoutNode) {
    if (node) {
      ...
      if (node.children) {
        ...
        node.children = [];
        var _iterator7 = _createForOfIteratorHelper2(childNodes), _step7;
        try {
          for (_iterator7.s(); !(_step7 = _iterator7.n()).done; ) {
            var childNode = _step7.value;
            var copyChildNode = _objectSpread6({}, childNode);
  ...
  var isFilterMatched = function isFilterMatched2(node, _ref3) {
    var filterField = _ref3.filterField, filterValue = _ref3.filterValue, filterConstraint = _ref3.filterConstraint, isStrictMode = _ref3.isStrictMode, options = _ref3.options;
    var matched = false;
    ...
    if (!props.lazy) {
      if (data2 && data2.length) {
        ...
        if (ObjectUtils.isNotEmpty(filters) || props.globalFilter) {
          data2 = filterLocal(data2);
        }
        if (sortField || ObjectUtils.isNotEmpty(multiSortMeta)) {
          if (props.sortMode === "single") {
            data2 = sortSingle(data2);
          } else if (props.sortMode === "multiple") {
            data2 = sortMultiple(data2);
          }
        }
      }
    }
  ...
  var createTableHeader = function createTableHeader2(columns, columnGroup) {
    var sortField = getSortField();
    var sortOrder = getSortOrder();
    var multiSortMeta = _toConsumableArray2(getMultiSortMeta());
    var filters = getFilters();
    return React24.createElement(TreeTableHeader, {
      hostName: "TreeTable",
      columns,
      columnGroup,
      tabIndex: props.tabIndex,
  ...
  var createTableFooter = function createTableFooter2(columns, columnGroup) {
    return React24.createElement(TreeTableFooter, {
      hostName: "TreeTable",
      columns,
      columnGroup,
      ptCallbacks,
  ...
  var createTableBody = function createTableBody2(value, columns) {
    return React24.createElement(TreeTableBody, {
      hostName: "TreeTable",
      checkboxIcon: props.checkboxIcon,
      columns,
      contextMenuSelectionKey: props.contextMenuSelectionKey,
  ...
  var createScrollableView = function createScrollableView2(value, columns, frozen, headerColumnGroup, footerColumnGroup) {
    ...
    return React24.createElement(TreeTableScrollableView, {
      hostName: "TreeTable",
      columns,
      header,
      body,
  ...
  var createScrollableTable = function createScrollableTable2(value) {
    var columns = getColumns();
    ...
    return React24.createElement("div", scrollableWrapperProps, frozenView, scrollableView);
  };
  var createRegularTable = function createRegularTable2(value) {
    var columns = getColumns();
    ...
    return React24.createElement("div", wrapperProps, React24.createElement("table", _extends22({
      ref: tableRef
    }, tableProps), header, footer, body));
  };
  var createTable = function createTable2(value) {
  ...
  var createLoader = function createLoader2() {
    if (props.loading) {
      ...
      var icon = props.loadingIcon || React24.createElement(SpinnerIcon, _extends22({}, loadingIconProps, {
        spin: true
      }));
      ...
      return React24.createElement("div", loadingWrapperProps, React24.createElement("div", loadingOverlayProps, loadingIcon));
    }
    return null;
  };
  var data = processedData();
  var table2 = createTable(data);
  ...
  var headerFacet = props.header && React24.createElement("div", headerProps, props.header);
  var footerFacet = props.footer && React24.createElement("div", footerProps, props.footer);
  ...
  var loader = createLoader();
  var resizeHelper = props.resizableColumns && React24.createElement("div", _extends22({
  ...
  var reorderIndicatorUpIcon = props.reorderableColumns && IconUtils.getJSXIcon(props.reorderIndicatorUpIcon || React24.createElement(ArrowDownIcon, reorderIndicatorUpIconProps), _objectSpread6({}, reorderIndicatorUpIconProps), {
    props
  });
  var reorderIndicatorUp = props.reorderableColumns && React24.createElement("span", _extends22({
  ...
  var reorderIndicatorDownIcon = IconUtils.getJSXIcon(props.reorderIndicatorDownIcon || React24.createElement(ArrowUpIcon, reorderIndicatorDownIconProps), _objectSpread6({}, reorderIndicatorDownIconProps), {
    props
  });
  var reorderIndicatorDown = props.reorderableColumns && React24.createElement("span", _extends22({
  ...
  return React24.createElement("div", _extends22({
    ref: elementRef
  }, rootProps), loader, headerFacet, paginatorTop, table2, paginatorBottom, footerFacet, resizeHelper, reorderIndicatorUp, reorderIndicatorDown);
});
TreeTable.displayName = "TreeTable";
export {
  TreeTable
};
//# sourceMappingURL=primereact_treetable.js.map
