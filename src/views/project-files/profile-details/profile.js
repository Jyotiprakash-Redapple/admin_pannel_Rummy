        ...
        <>
            ...
            <div className='row'>
                <div className="d-flex bd-highlight">
                    <div className="p-2 w-100 bd-highlight"><h3 className="hed_txt pt-2">My Profile</h3></div>
                ...
                <div className='col-8'>
                    <AccountList clientData={clientData?._id} client_name={clientData?.first_name + ' ' + clientData?.last_name} />
                </div>
            </div>
