				...
				<CTable hover bordered responsive>
                    ...
                    <button
                      ...
                      className={`${styles.editBtn} ${FEATURE.isEdit == false ? 'prevent_default' : 'auto'}`}
									...
									{/* USERNAME */}
									<CTableDataCell className='text-center'>{u.admin_username}</CTableDataCell>
									...
									<CTableDataCell className='text-center'>
										<CBadge
											color={u.admin_status === "active" ? "success" : "danger"}
											onClick={() => {
											...
											style={{ cursor: "pointer" }} className={` ${FEATURE.isEdit == false ? 'prevent_default' : 'auto'}`}
					...
					<CCardBody>
						<CForm>
							...
							<div className='mb-3'>
								...
								<CFormSelect
									id='role_name'
									defaultValue={updateAdmin.role_id}
							...
							<div className='mb-3'>
								...
								<CFormInput
									...
									id='contact'
									placeholder='Enter contact number'
									value={updateAdmin.admin_contact}
									onChange={(e) => {
										setUpdateAdmin((prev) => {
											return {
												...prev,
							...
							<div className='mb-3'>
								...
								<CFormInput
									...
									id='username'
									placeholder='Choose a username'
									value={updateAdmin.admin_username}
									onChange={(e) => {
										setUpdateAdmin((prev) => {
											return {
												...prev,
							...
							<div className='mb-3'>
								...
								<CFormInput
									...
									id='password'
									placeholder='Enter password'
									value={updateAdmin.admin_password}
									onChange={(e) => {
										setUpdateAdmin((prev) => {
											return {
												...prev,
							...
							<CButton color='primary' type='submit' onClick={UpdateAdminToServer}>
								Submit
							</CButton>
							<CButton
								color='secondary'
